...
elyra-metadata install runtime-images --schema_name=runtime-image \
       ...
       --display_name="Tensorflow 2.4.1 with GPU" \
       --description="TensorFlow 2.4 (with GPU support)" \
       --image_name="quay.io/ibm/kubeflow-elyra-runtimes-ppc64le:py3.8-tensorflow2.4.1" \
       --tags="['gpu', 'tensorflow']" \
       --replace
...
elyra-metadata install runtime-images --schema_name=runtime-image \
       ...
       --description="TensorFlow 2.4" \
       --image_name="quay.io/ibm/kubeflow-elyra-runtimes-ppc64le:py3.8-tensorflow-cpu2.4.1" \
       --tags="['tensorflow']" \
       --replace
